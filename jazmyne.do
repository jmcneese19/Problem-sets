...
gr matrix evictionrate pctwhite pctasian pctrenteroccu , half

//useful to label
scatter pctasian pctrenteroccu, ml(year)
...
gr hbar evictionrate pctwhite, over(countyname, sort(pctwhite)) name(WEVI, replace)
...
//NEED HELP when defining local drop `' :) easy! 
